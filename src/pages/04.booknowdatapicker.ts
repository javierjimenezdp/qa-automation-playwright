...
export class Booknowdatapicker {
    ...
    constructor(page: Page) {
        ...
        this.selectdatecheckin = page.locator('#root-container #booking .container form .col-md-6 .form-control').nth(0)
        this.selectdatecheckout = page.locator('#root-container #booking .container form .col-md-6 .form-control').nth(1)
        this.checkavaialibility = page.locator('#root-container #booking .container form .col-8.mt-4 .btn-primary')
    ...
    async waitFirstCardReady() {
        ...
        await expect(this.firstcardimage).toHaveAttribute('src', /.+/, { timeout: 10_000 });
    }
}
