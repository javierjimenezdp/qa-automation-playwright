...
export class NavBar{
    ...
    constructor(page: Page){
        this.page = page;
        this.rooms = page.locator('#root-container .navbar-light #navbarNav .nav-item .nav-link').nth(0); 
        this.booking = page.locator('#root-container .navbar-light #navbarNav .nav-item .nav-link').nth(1); 
        this.amenities = page.locator('#root-container .navbar-light #navbarNav .nav-item .nav-link').nth(2); 
        this.location = page.locator('#root-container .navbar-light #navbarNav .nav-item .nav-link').nth(3); 
        this.contact = page.locator('#root-container .navbar-light #navbarNav .nav-item .nav-link').nth(4); 
        this.admin = page.locator('#root-container .navbar-light #navbarNav .nav-item .nav-link').nth(5); 
        this.collapse = page.locator('#navbarNav')
        this.navbartoggler = page.locator('[data-bs-toggle="collapse"][data-bs-target="#navbarNav"], button[aria-controls="navbarNav"]');
    }
