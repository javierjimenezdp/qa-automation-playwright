...
export class Sendmessage {
    ...
    constructor(page: Page) {
        this.page = page;   
        this.nameinput = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .form-control').nth(0)
        this.emailinput = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .form-control').nth(1)
        this.phoneinput = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .form-control').nth(2)
        this.subjectinput = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .form-control').nth(3)
        this.messageinput = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .form-control').nth(4)
        this.grongsubmited = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .alert.alert-danger')
        this.succesfullysubmited = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .card-body.p-4')
        this.submitbutton = page.locator('#root-container #contact .container .col-lg-8 .card.shadow .btn.btn-primary')
    }
    ...
    async messagesectionwrong(){
        ...
        await expect(this.messageinput).toBeVisible()
        await this.messageinput.fill('Test to each input on the message section to verify it each one of them meet the validations')
    ...
    async messagesectionsucesfully(){
        const lastnames = ["Perez", "Gomez", "Lopez", "Martinez", "Rodriguez", "Castro", "Diaz"];
        ...
        expect(messagesuccesfullyutils).toContain(`${nameinputstring} ${randomlastname}`)
    }
